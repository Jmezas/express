...
(function (d) {
                    ...
                    for (var g = 0, h = e.length; g < h; g++) {
                        ...
                        if (f.key)
                            if (f.key === a) (b._buttonsHandled = !0), d(q).click();
                                ...
                                if (!f.key.altKey || b.altKey) if (!f.key.ctrlKey || b.ctrlKey) if (!f.key.metaKey || b.metaKey) (b._buttonsHandled = !0), d(q).click();
    ...
    l.defaults = {
        ...
        tabIndex: 0,
        dom: {
            container: { tag: "div", className: "dt-buttons col-lg-6 col-md-6 col-sm-12 col-12 esp-caj" },
            ...
            action: function (a, b, c, e) {
                ...
                f && "absolute" === g
                    ...
                    ? (e._collection.css({ top: a.top + c.outerHeight(), left: a.left }),
                      ...
                      (g = h.offset().top - g),
                      (f > g || e.dropup) && e._collection.css("top", a.top - e._collection.outerHeight() - 5),
                      ...
                      c > d(n).width() && e._collection.css("left", a.left - (c - d(n).width())))
                    : ((c = e._collection.height() / 2), c > d(n).height() / 2 && (c = d(n).height() / 2), e._collection.css("marginTop", -1 * c));
